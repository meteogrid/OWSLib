...
from .coverage import wcs100, wcs110, wcs111, wcs201, wcsBase
...
def WebCoverageService(url, version=None, xml=None, cookies=None, timeout=30):
    ...
    if version == '1.0.0':
        ...
        return wcs201.WebCoverageService_2_0_1.__new__(wcs201.WebCoverageService_2_0_1, clean_url, xml, cookies)
